...
export const events = {
  ...
  incident: (delta = 1): DeskHubEvent => event("IncidentReceived", "iracing", 70, `${delta}X`, [255, 0, 0]),
  blueFlag: (): DeskHubEvent => event("BlueFlag", "iracing", 60, "BLUE", [0, 80, 255], 1800, true),
